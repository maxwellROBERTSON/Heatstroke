...
#			undef CASE_
	...
	std::string toString(VkDebugUtilsMessageSeverityFlagBitsEXT aSeverity) {
		// See
...
#			undef CASE_
	...
	std::string queueFlags(VkQueueFlags aFlags) {
		std::ostringstream oss;
...
#		undef APPEND_
	...
	std::string messageTypeFlags(VkDebugUtilsMessageTypeFlagsEXT aFlags) {
		std::ostringstream oss;
...
#		undef APPEND_
	...
	std::string memoryHeapFlags(VkMemoryHeapFlags aFlags) {
		std::ostringstream oss;
...
#		undef APPEND_
	...
	std::string memoryPropertyFlags(VkMemoryPropertyFlags aFlags) {
		std::ostringstream oss;
