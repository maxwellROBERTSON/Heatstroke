...
public:
	// Constructor
	GUI() = default;
	GUI(FPSTest* game) : game(game) {}

	// Getters
	ImFont* GetFont(std::string s);
	std::tuple<Engine::vk::Sampler, Engine::vk::Texture, Engine::vk::ImageView, VkDescriptorSet>* GetImage(std::string s);
...
private:
	...
	std::map<std::string, std::tuple<Engine::vk::Sampler, Engine::vk::Texture, Engine::vk::ImageView, VkDescriptorSet>> images;
