...
namespace Engine
{
	...
	public:
		...
		void SetTranslation(glm::vec3 t) { translation = t; SetComponentHasChanged(); }
...
//		};
//
//		PhysicsComponent() : game(nullptr), entity(nullptr) {}
//		PhysicsComponent(Engine::Game* game, Engine::Entity* entity) : game(game), entity(entity) {}
//
//		// Getters
//
//		// Static type getter from Component parent
...
//
//		// Setters
//		void SetIsPerson(bool aIsPerson)
//		{
//			isPerson = aIsPerson;
//			if (!hasChanged)
//			{
