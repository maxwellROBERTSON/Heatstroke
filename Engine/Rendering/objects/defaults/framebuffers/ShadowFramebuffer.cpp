...
ShadowFramebuffer::ShadowFramebuffer(
	...
	VkExtent2D* renderExtent) : HsFramebuffer(window) {
...
void ShadowFramebuffer::recreate() {
	...
	Engine::createFramebuffers(*this->window, this->framebuffers, this->renderPass->getHandle(), shadowViews, *this->renderExtent, true);
}
